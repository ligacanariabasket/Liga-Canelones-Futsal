...
type SeasonWithTeamsAndTeamData = Season & { teams: (SeasonTeam & { team: Team })[] };

export default function GestionPartidosPage() {
    const [matches, setMatches] = useState<FullMatch[]>([]);
    const [seasons, setSeasons] = useState<SeasonWithTeamsAndTeamData[]>([]);
    ...
    useEffect(() => {
        async function loadData() {
            ...
            const [matchesData, seasonsData] = await Promise.all([
                getAllMatches(),
                getAllSeasonsWithTeams()
            ]);
            setMatches(matchesData);
            setSeasons(seasonsData as SeasonWithTeamsAndTeamData[]);
